...
export const NavBar = () => {
    ...
    const start = <img alt="logo" src={kruger} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} height="40" className="mr-2"></img>;
    const end = 
    (
        canSearch==true?
