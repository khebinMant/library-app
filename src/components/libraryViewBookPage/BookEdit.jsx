    ...
    <div className="form-book">
      ...
      >
        <div className="flex align-items-center flex-column pt-6 px-3">
          ...
          ></i>
          <h2  style={{ textAlign:'center'}}>Libro actulizado satisfactoriamente</h2>
      ...
      <div className="flex justify-content-center">
        <div className="card">
          <form onSubmit={formik.handleSubmit} className="p-fluid">
            ...
            <div className="check-input-edit">
            ...
            <Button type="submit" label="Actualizar" className="p-button-rounded p-button-success" />
          </form>
        </div>
      </div>
    </div>
